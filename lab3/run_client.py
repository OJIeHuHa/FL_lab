...
def run_client():
    ...
    parser.add_argument('--type',type=str, default="norm", help = "Type of client: norm - normal, model - model poisoning, data - data poisoning")
    ...
    client = CustomClient(model, train_loader, val_loader, device, client_type=args.type)
